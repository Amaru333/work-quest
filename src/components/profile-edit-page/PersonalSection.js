      ...
      <div className="flex flex-col gap-y-6">
        <div className="flex gap-x-12">
          <div className="flex flex-col w-2/5">
            ...
            <p className="text-xs text-gray-400 font-medium">{PROFILE_EDIT_PAGE_STRINGS.full_name_message[lang]}</p>
          </div>
          <div className="w-3/5">
            <UITextInput placeholder={COMMON_STRINGS.full_name[lang]} />
          </div>
        </div>
        <div className="flex gap-x-12">
          <div className="flex flex-col w-2/5">
            <p className="text-xl font-semibold">{PROFILE_EDIT_PAGE_STRINGS.profile_url[lang]}</p>
            <p className="text-xs text-gray-400 font-medium">{PROFILE_EDIT_PAGE_STRINGS.profile_url_message[lang]}</p>
          </div>
          <div className="w-3/5">
            <div className="w-full border border-slate-400 rounded-md flex">
              <p className="px-3 py-2 border-r border-slate-400 text-slate-600 text-sm">website.com/</p>
              <input className="flex-1 px-2 text-sm" placeholder="full-name" />
        ...
        <div className="flex gap-x-12">
          ...
          <div className="w-3/5">
            <UITextInput placeholder={COMMON_STRINGS.email_address[lang]} />
          </div>
        </div>
        <div className="flex gap-x-12">
          <div className="flex flex-col w-2/5">
            <p className="text-xl font-semibold">{PROFILE_EDIT_PAGE_STRINGS.phone_number[lang]}</p>
            <p className="text-xs text-gray-400 font-medium">{PROFILE_EDIT_PAGE_STRINGS.phone_number_message[lang]}</p>
          </div>
          <div className="w-3/5">
            <UITextInput placeholder="000-000-0000" />
          </div>
        </div>
        <div className="flex gap-x-12">
          <div className="flex flex-col w-2/5">
            <p className="text-xl font-semibold">{PROFILE_EDIT_PAGE_STRINGS.profile_picture[lang]}</p>
            <p className="text-xs text-gray-400 font-medium">{PROFILE_EDIT_PAGE_STRINGS.profile_picture_message[lang]}</p>
          </div>
          <div className="w-3/5 flex gap-x-4">
            ...
            <div className="flex-1 text-sm font-semibold flex flex-col items-center justify-center border border-dotted border-gray-400 rounded-md py-4">
              ...
              <p>
                <span className="underline text-primary-100">{PROFILE_EDIT_PAGE_STRINGS.click_to_upload[lang]}</span>
              </p>
