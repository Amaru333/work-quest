      ...
      <div className="flex flex-col gap-y-6">
        <div className="flex gap-x-12">
          <div className="flex flex-col w-2/5">
            ...
            <p className="text-xs text-gray-400 font-medium">{PROFILE_EDIT_PAGE_STRINGS.company_name_message[lang]}</p>
          </div>
          <div className="w-3/5">
            <UITextInput placeholder={PROFILE_EDIT_PAGE_STRINGS.company_name[lang]} />
          </div>
        </div>
        <div className="flex gap-x-12">
          <div className="flex flex-col w-2/5">
            <p className="text-xl font-semibold">{PROFILE_EDIT_PAGE_STRINGS.location[lang]}</p>
            <p className="text-xs text-gray-400 font-medium">{PROFILE_EDIT_PAGE_STRINGS.company_location_message[lang]}</p>
          </div>
          <div className="w-3/5">
